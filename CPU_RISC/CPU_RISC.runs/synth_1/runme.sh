...
HD_PWD='/home/carraz-b/4A/PSI/PSI_INSA/CPU_RISC/CPU_RISC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PROC_FINAL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PROC_FINAL.tcl
